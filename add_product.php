...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO `product`(`product_name`, `product_price`, `product_description`, `product_image`) VALUES ('$product_name','$product_price','$product_description','$product_image')";
    $link->query($sql);
    header("Location: /product.php");
}
...
<body>
  ...
  <h1>Add Product</h1>
      ...
      <div class="col-md col-sm-12 form-group">
        ...
        <div class="col-md col-sm-12 form-group">
            <input type="number" name="product_price" placeholder="Product Price" class="form-control" value="" required>
        </div>
        <div class="col-md col-sm-12 form-group">
            <textarea name="Product_description" placeholder="Product Description" class="form-control" value="" required></textarea>
        </div>
        <div class="col-12 form-group">
            <input type="text" name="product_image" placeholder="Product Image" class="form-control" value="" required>
        </div>
        <hr>
